...
const HomePage = () => {
  ...
  return (
    <div className="dark:bg-dark-primary container h-full w-[100%] bg-transparent p-8">
      <Header name="TeamLoom Dashboard" />
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="dark:bg-dark-secondary rounded-lg bg-white p-4 shadow">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie dataKey="count" data={projectStatus} fill="#82cs9d" label>
